...
#INSERT INTO User(username,password,first_name,last_name,type,email) VALUES('dimitrios','5f4dcc3b5aa765d61d8327deb882cf99','Dimitrios','Pezaros',1,'cieslaremil@gmail.com');
...
# Drop function
DROP FUNCTION IF EXISTS `NextMonday`;
# Function to get the next monday date
CREATE FUNCTION `NextMonday`() RETURNS DATE
  RETURN DATE_SUB(CURDATE(), INTERVAL (WEEKDAY(CURDATE())-6) DAY);

SET @now_meeting = CONCAT(DATE_FORMAT(NextMonday(),'%Y-%m-%d'),' 16:00:00');
...
# One that tests no show, however it is not week after no show so the buttons should be still there
INSERT INTO Meeting(datetime, is_repeating, repeat_until, is_approved, taken_place, arrived_on_time, project_id)
  VALUES(@now_meeting - INTERVAL 2 DAY,1,@now_meeting + INTERVAL 21 DAY,1,0,0,1);
INSERT INTO Meeting(datetime, is_repeating, repeat_until, is_approved, taken_place, arrived_on_time, project_id)
...
######### ACTION POINTS
# First week
INSERT INTO ActionPoint(deadline, datetime_done, datetime_created, text, is_approved, is_done, sent_for_approval, grade, meeting_id, user_id, project_id)
    VALUES(@now_meeting - INTERVAL 35 DAY,@now_meeting - INTERVAL 36 DAY,@now_meeting - INTERVAL 42 DAY,'Questionnaire',1,1,1,19,1,1,1);
INSERT INTO ActionPoint(deadline, datetime_done, datetime_created, text, is_approved, is_done, sent_for_approval, grade, meeting_id, user_id, project_id)
    VALUES(@now_meeting - INTERVAL 35 DAY,@now_meeting - INTERVAL 36 DAY,@now_meeting - INTERVAL 42 DAY,'Requirements draft (User stories, MoSCoW)',1,1,1,21,1,1,1);
INSERT INTO ActionPoint(deadline, datetime_done, datetime_created, text, is_approved, is_done, sent_for_approval, grade, meeting_id, user_id, project_id)
    VALUES(@now_meeting - INTERVAL 35 DAY,@now_meeting - INTERVAL 36 DAY,@now_meeting - INTERVAL 42 DAY,'What am I going to implement',1,1,1,20,1,1,1);
...
INSERT INTO ActionPoint(deadline, datetime_done, datetime_created, text, is_approved, is_done, sent_for_approval, grade, meeting_id, user_id, project_id)
    VALUES(@now_meeting - INTERVAL 28 DAY,@now_meeting - INTERVAL 29 DAY,@now_meeting - INTERVAL 35 DAY,'First iteration',1,1,1,21,2,1,1);

# Third week
INSERT INTO ActionPoint(deadline, datetime_done, datetime_created, text, is_approved, is_done, sent_for_approval, grade, meeting_id, user_id, project_id)
    VALUES(@now_meeting - INTERVAL 21 DAY,@now_meeting - INTERVAL 22 DAY,@now_meeting - INTERVAL 28 DAY,'Second iteration',1,1,1,21,3,1,1);

# Forth week
INSERT INTO ActionPoint(deadline, datetime_done, datetime_created, text, is_approved, is_done, sent_for_approval, grade, meeting_id, user_id, project_id)
    VALUES(@now_meeting - INTERVAL 14 DAY,@now_meeting - INTERVAL 15 DAY,@now_meeting - INTERVAL 21 DAY,'Start writing the introduction',1,1,1,19,4,1,1);
...
INSERT INTO ActionPoint(deadline, datetime_done, datetime_created, text, is_approved, is_done, sent_for_approval, grade, meeting_id, user_id, project_id)
    VALUES(@now_meeting - INTERVAL 14 DAY,@now_meeting - INTERVAL 15 DAY,@now_meeting - INTERVAL 21 DAY,'Update User stories with progress',1,1,1,20,4,1,1);
INSERT INTO ActionPoint(deadline, datetime_done, datetime_created, text, is_approved, is_done, sent_for_approval, grade, meeting_id, user_id, project_id)
    VALUES(@now_meeting - INTERVAL 14 DAY,@now_meeting - INTERVAL 15 DAY,@now_meeting - INTERVAL 21 DAY,'Third iteration',1,1,1,20,4,1,1);

# Fifth week
INSERT INTO ActionPoint(deadline, datetime_done, datetime_created, text, is_approved, is_done, sent_for_approval, grade, meeting_id, user_id, project_id)
    VALUES(@now_meeting - INTERVAL 7 DAY,@now_meeting - INTERVAL 8 DAY,@now_meeting - INTERVAL 14 DAY,'Update of the introduction',1,1,1,19,5,1,1);
INSERT INTO ActionPoint(deadline, datetime_done, datetime_created, text, is_approved, is_done, sent_for_approval, grade, meeting_id, user_id, project_id)
    VALUES(@now_meeting - INTERVAL 7 DAY,@now_meeting - INTERVAL 8 DAY,@now_meeting - INTERVAL 14 DAY,'Forth iteration',1,1,1,21,5,1,1);
INSERT INTO ActionPoint(deadline, datetime_created, text, is_approved, is_done, sent_for_approval, grade, meeting_id, user_id, project_id)
...
# Testing different project scope of an action point
INSERT INTO ActionPoint(deadline, datetime_created, text, is_approved, is_done, sent_for_approval, grade, meeting_id, user_id, project_id)
  VALUES(@now_meeting + INTERVAL 1 DAY,@now_meeting - INTERVAL 7 DAY,'Meeting filtering (different project scope)',1,0,1,0,6,1,2);
...
# Drop function
DROP FUNCTION IF EXISTS `LastMonday`;
